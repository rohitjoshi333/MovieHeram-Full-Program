...
public class SessionUtil {
    ...
    public static void setRegisteredUserId(HttpServletRequest request, int userId) {
        setAttribute(request, "registeredUserId", userId);
    }

    public static Integer getRegisteredUserId(HttpServletRequest request) {
        Object value = getAttribute(request, "registeredUserId");
        return (value instanceof Integer) ? (Integer) value : null;
    }

    public static void clearRegisteredUserId(HttpServletRequest request) {
        removeAttribute(request, "registeredUserId");
    }
}